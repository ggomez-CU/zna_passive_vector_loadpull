...
if __name__ == "__main__":
    ...
    output_file = os.getcwd() + "\\data\\simpleloadpull_samplers\\" \
            + now + "_Freq" \
    ...
    loadtuner.connect()
    loadtuner.configure()
    position_cal = LoadTunerCalCalc(r"C:\Users\grgo8200\LocalOnly\DiscreteIS\SubSixTestHybridBoard\subsixtest\data\LTfreqSparam\3000MHz.txt",
