...
if __name__ == "__main__":
    ...
    loadtuner.connect()
    loadtuner.configure()
    # position_cal = LoadTunerCalCalc(rf"C:\Users\grgo8200\LocalOnly\DiscreteIS\SubSixTestHybridBoard\subsixtest\data\LTfreqSparam\3GHz.txt",
...
position_cal = LoadTunerCalCalc(rf"C:\Users\grgo8200\LocalOnly\DiscreteIS\SubSixTestHybridBoard\subsixtest\data\LTfreqSparam\{int(freq*1000)}MHz.txt",14000, 8500, 12.7)