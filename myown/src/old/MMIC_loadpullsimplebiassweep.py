...
#region Options
    ...
    config = MMICLoadPullBiasConfig(r"C:\Users\grgo8200\Documents\GitHub\summer2025_loadpull_repo\data\PA_Spring2023\MMIC_loadpullbias_config.json")
...
#region Initialize Instruments
    ...
    for idx, bias in enumerate(config.drainbiasvoltage):
        pna.power_off()
        dc_supply.set_channel(config.dc_supply_config.gate_channel,bias,0.1) #channel voltage current
